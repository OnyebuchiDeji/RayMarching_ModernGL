...
vec2 map(vec3 p) {
    ...
    roofDist -= bumpMapping(u_texture7, p, p - roofBumpFactor, roofDist,
                            roofBumpFactor, roofScale);
    ...
    wallDist -= bumpMapping(u_texture3, op, op + wallBumpFactor, wallDist,
                            wallBumpFactor, wallScale);
    float wallID = 3.0;
