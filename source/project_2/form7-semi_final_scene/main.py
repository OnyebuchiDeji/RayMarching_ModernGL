...
class App(mglw.WindowConfig):
    ...
    def render(self, time, frame_time):
        ...
        self.texture1.use(location=2)
        self.texture1.use(location=3)
        self.texture1.use(location=4)
        self.texture1.use(location=5)
        self.texture1.use(location=6)
        self.texture1.use(location=7)
